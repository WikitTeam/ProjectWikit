...
const (
	forumNewThreadGolden = "testdata/forumnewthread.golden"
	forumNewThreadCorpus = "testdata/forumnewthread_corpus.json"
)

type forumNewThreadCase struct {
...
func forumNewThreadCases() []forumNewThreadCase {
	return []forumNewThreadCase{
		{Name: "chat", Viewer: "", Category: "Probe Chat"},
		{Name: "chat-signed-in", Viewer: "probe-author", Category: "Probe Chat"},
		{Name: "chat-superuser", Viewer: "probe-staff", Category: "Probe Chat"},
		...
		{Name: "hidden-section-superuser", Viewer: "probe-staff", Category: "Probe Hidden Chat"},
		{Name: "comments-superuser", Viewer: "probe-staff", Category: "Probe Comments"},
...
func forumNewThreadPath(t *testing.T, c forumNewThreadCase, categories []db.ForumCategory) page.PathParams {
	t.Helper()
