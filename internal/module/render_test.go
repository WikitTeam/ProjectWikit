...
func TestEveryPortedModuleAnswers(t *testing.T) {
	ported := []string{"applicationform", "button", "comments", "countpages", "css", "files", "forumcategory", "forumnewthread", "forumstart", "forumthread", "gallery", "listpages", "listusers", "members", "membershipbypassword", "newpage", "pagedescription", "pageimage", "pagesbytag", "rate", "recentposts", "redirect", "search", "sitechanges", "tagcloud", "time", "wantedpages"}
