...
func TestEveryPortedModuleAnswers(t *testing.T) {
	ported := []string{"css", "forumcategory", "forumnewthread", "forumstart", "forumthread", "listpages", "pagedescription", "pageimage", "pagesbytag", "rate", "recentposts", "redirect", "search", "sitechanges"}
