"""
Django settings for wikitgo project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'web.context_processors.site_branding',
            ],
        },
    },
]
...
WSGI_APPLICATION = 'wikitgo.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_PG_DATABASE', 'projwikit'),
        'USER': os.environ.get('DB_PG_USERNAME', 'admin'),
        'PASSWORD': os.environ.get('DB_PG_PASSWORD', 'wikitpassword'),
