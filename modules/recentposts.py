                ...
                <tr>
                    ...
                    <td>
                        <select id="recent-posts-category">
                            <option value="*"{% if category_param == '*' %} selected{% endif %}>所有版块</option>
                        ...
                        <input class="buttons btn btn-primary" type="button" value="刷新">
                    </td>
                </tr>
                </tbody>
                </table>
