...
api_patterns = [
    ...
    path('users/lookup', users.LookupUserView.as_view()),
    path('users/generate-invite', users.GenerateInviteLinkView.as_view()),
    ...
    path('messages/send', api_messages.SendMessageView.as_view()),
...
sys_patterns = [
    ...
    path("users/<str:name>", profile.ProfileView.as_view(template_name="profile/user.html"), name="users_by_name"),
