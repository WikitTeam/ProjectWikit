    ...
    for article in Article.objects.using(db).all():
        ...
        for rename in renames:
            if real_current_dir_name == rename.meta['name']:
                ...
                raise ValueError('完整性错误：预期重命名为 %s，但找到 %s' % (real_current_dir_name, rename.meta['name']))
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='article',
            name='media_name',
            field=models.TextField(default=uuid4, unique=True, verbose_name='文件系统中文件文件夹的名称'),
        ),
    ]
