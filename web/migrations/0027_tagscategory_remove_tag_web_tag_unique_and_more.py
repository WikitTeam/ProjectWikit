    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField(verbose_name='完整名称')),
                ('description', models.TextField(blank=True, verbose_name='描述')),
                ('priority', models.PositiveIntegerField(null=True, blank=True, verbose_name='排序编号')),
                ('slug', models.TextField(unique=True, verbose_name='标识符')),
            ],
            options={
                'verbose_name': '标签分类',
        ...
        migrations.AddField(
            model_name='tag',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='web.tagscategory', verbose_name='分类'),
        ),
        migrations.AddIndex(
            model_name='tag',
